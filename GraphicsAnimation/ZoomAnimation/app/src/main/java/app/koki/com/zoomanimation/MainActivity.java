package app.koki.com.zoomanimation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewThumbnail.setImageBitmap(loadSampledResource(R.drawable.sheep, 100, 100));
    ...
    private void zoomFromThumbnail(final ImageView imageViewThumb) {
        ...
        findViewById(R.id.activity_main).getGlobalVisibleRect(finalBounds, globalOffset);
        mImageViewExpanded.setImageBitmap(loadSampledResource(R.drawable.sheep, finalBounds.height(), finalBounds.width()));
